...
module.exports = function(){
    ...
    it('click: 投标邀请 ( #leftNav ul.fui-nav-items > li:nth-child(2) > a:nth-child(1) > span.fui-nav-text, 42, 12, 0 )', function(){
        return driver.sleep(600).wait('/html/body/div[2]/div[1]/ul/li[1]/div/ul/li[3]/a/span', 30000)
            .sleep(300).mouseMove(42, 12).click(0);
    });

    it('click: 招标公告 ( #leftNav ul.sub > li:nth-child(1) > a.fui-nav-link > span.fui-nav-text, 13, 3, 0 )', function(){
        return driver.sleep(600).wait('/html/body/div[2]/div[1]/ul/li[1]/div/ul/li[3]/ul/li[1]/a/span', 30000)
            .sleep(300).mouseMove(13, 3).click(0);
    });

    // it('switchFrame: #tab-content-102100010004 iframe', function(){
    //     return driver.switchFrame(null)
    //         .wait('/html/body/div[2]/div[2]/div[2]/div[2]/iframe', 30000).then(function(element){
