...
module.exports = function(){
    ...
    it('url: http://192.168.200.141:8090/TPFrame_JC/CustomFrame4Bid/FrameAll.aspx', function(){
        return driver.url(_('http://192.168.200.141:8090/TPFrame_JC/CustomFrame4Bid/FrameAll.aspx'));
    });
    ...
    it('click: 请输入用户名 ( #txtUserName_DefaultMask, 32, 24, 0 )', function(){
        return driver.sleep(300).wait('#txtUserName', 30000)
               .sleep(300).mouseMove(32, 24).click(0);
    });
    ...
    it('click: 请输入密码 ( #txtPwd_DefaultMask, 25, 16, 0 )', function(){
        return driver.sleep(300).wait('#txtPwd', 30000)
               .sleep(300).mouseMove(25, 16).click(0);
    });

    it('sendKeys: 11111', function(){
        return driver.sendKeys('11111');
    });

    it('click: #Imagebutton1, 133, 22, 0', function(){
        return driver.sleep(300).wait('#Imagebutton1', 30000)
               .sleep(300).mouseMove(133, 22).click(0);
    });
    ...
    it('click: #aspnetForm div.icons2424-72, 28, 33, 0', function(){
        return driver.sleep(300).wait('#aspnetForm div.icons2424-72', 30000)
               .sleep(300).mouseMove(28, 33).click(0);
    });
